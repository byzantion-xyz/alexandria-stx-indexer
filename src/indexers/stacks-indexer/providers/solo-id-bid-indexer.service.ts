...
import { CreateActionTO, CreateBidActionTO, CreateCollectionBidActionTO, CreateIdBidActionTO, CreateSoloBidActionTO } from 'src/indexers/common/interfaces/create-action-common.dto';
