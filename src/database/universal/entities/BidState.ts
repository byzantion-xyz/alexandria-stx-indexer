...
export class BidState {
  ...
  @OneToMany(() => BidStateNftMeta, (bidStateOnNftMeta) => bidStateOnNftMeta.bid_state, { cascade: true })
  nft_metas: BidStateNftMeta[];

  @OneToMany(() => BidAttribute, (bidAttribute) => bidAttribute.bid_state, { cascade: true })
