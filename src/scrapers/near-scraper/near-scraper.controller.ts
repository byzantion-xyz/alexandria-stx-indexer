...
export class NearScraperController {
  ...
  @Post('scrape')
  async scrape(
    @Body() data: { slug, contract_key, token_series_id, token_id, starting_token_id, ending_token_id, scrape_non_custodial_from_paras, pin_multiple_images, force_scrape}
  ) {
