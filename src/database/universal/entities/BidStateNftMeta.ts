...
export class BidStateNftMeta {
  ...
  @ManyToOne(() => BidState, (bidState) => bidState.nft_metas, { onDelete: "RESTRICT", onUpdate: "CASCADE" })
  @JoinColumn([{ name: "bid_id", referencedColumnName: "id" }])
  bid_state: BidState;

  @ManyToOne(() => NftMeta, (nftMeta) => nftMeta.bid_states, { onDelete: "RESTRICT", onUpdate: "CASCADE" })
